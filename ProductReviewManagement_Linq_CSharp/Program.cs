...
namespace ProductReviewManagement_Linq_CSharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            new ProductReview() { ProductId = 1, UserId = 2, Rating = 4, Review = "Nice", isLike=true },
            ...
            new ProductReview() { ProductId = 6, UserId = 12, Rating = 4, Review = "Nice", isLike=true },
            ...
            new ProductReview() { ProductId = 9, UserId = 10, Rating = 3.5, Review = "Bad", isLike=false },
            new ProductReview() { ProductId = 10, UserId = 10, Rating = 5, Review = "Bad", isLike=false },
            ...
            new ProductReview() { ProductId = 15, UserId = 10, Rating = 5, Review = "Bad", isLike=false },
            new ProductReview() { ProductId = 16, UserId = 6, Rating = 4, Review = "Nice", isLike=true },
            new ProductReview() { ProductId = 17, UserId = 10, Rating = 3, Review = "Good", isLike=true },
            ...
            new ProductReview() { ProductId = 22, UserId = 10, Rating = 4, Review = "Nice", isLike=true },
            ...
            Console.WriteLine("Get_Nice_Review");
            productManagement.GetNiceReview(list);
            Console.WriteLine("Data ID 10 Record ");
            productManagement.GetRecord_ByUserID(list);
            Console.ReadKey();
        }
    }
}
